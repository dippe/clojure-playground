...
; (use 'hello-world.core :reload-all)  (primeBenchmark 100)
;(defn primeBenchmark [num]
;  ;(println "** is-prime-for?")
;  ;(quick-bench (is-prime-for? num))
;  (println "** is-prime-loop?")
;  (quick-bench (is-prime-loop? num))
;  ;(println "** isPrime0")
;  ;(quick-bench (isPrime1 num))
;  ;(println "** isPrime1")
;  ;(quick-bench (isPrime1 num))
;  ;(println "** isPrime1_1")
;  ;(quick-bench (isPrime1_1 num))
;  (println "** isPrime1_2")
;  (quick-bench (isPrime1_2 num))
;  (println "** isPrime1_3")
;  (quick-bench (isPrime1_3 num))
;  ;(println "** isPrime2")
;  ;(quick-bench (isPrime2 num))
;  ;(println "** isPrime3")
;  ;(quick-bench (isPrime3 num))
;  ;(println "** isPrime4")
;  ;(quick-bench (isPrime4 num))
;  ;(println "** isPrime5")
;  ;(quick-bench (isPrime5 num))
;  ;(println "** isPrime6")
;  ;(quick-bench (isPrime6 num))
;  )
